...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "depends": [
            "/opt/python/cp314-cp314/include/python3.14/Python.h",
            "/opt/python/cp314-cp314/include/python3.14/datetime.h",
            "/opt/python/cp314-cp314/include/python3.14/pythread.h",
            "srsly/msgpack/pack.h"
        ],
        "include_dirs": [
            "srsly/msgpack",
            "/opt/python/cp314-cp314/include/python3.14",
            ".",
            "srsly"
        ],
        "language": "c++",
